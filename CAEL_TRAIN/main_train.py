...
parser.add_argument('--trainA_img_path',type=str,default='/data/PALM/trainA_img/')  ###training images with class A are placed into this folder
parser.add_argument('--trainB_img_path',type=str,default='/data/PALM/trainB_img/')  ###training images with class B are placed into this folder
parser.add_argument('--testA_img_path',type=str,default='/data/PALM/testA_img/') ###testing images with class A are placed into this folder
parser.add_argument('--testB_img_path',type=str,default='/data/PALM/testB_img/') ###testing images with class B are placed into this folder
parser.add_argument('--train_label_file',type=str,default='/data/PALM/trainAB_img-name_label.txt')  #### name and label of each training image are presented in each line in this file, like the first line:"fundus_image_name1 1", where 1 refers to the abnormal class.
parser.add_argument('--test_label_file',type=str,default='/data/PALM/testAB_img-name_label.txt')
