...
class setting_config:
    ...
    network = 'CML4SOD'  ### Cross-modal learning for segmenting optic disc (CML4SOD)
    model_config = {
        'num_classes': 1, 
        'input_channels': 3,
        'depths': [2,2,2,2],
        ...
        'drop_path_rate': 0.2,
        'load_ckpt_path': './pre_trained_weights/pre_trained_weights.pth'  ### None or load pretrained weights
    }

    datasets = 'REFUGE'


    data_path_train_img = 'train_img_path/' ### training images are put into this folder.
    data_path_train_msk = 'train_img_mask_annotation_path/' ### the optic disc groundtruth masks of the training images are put into this folder.

    data_path_val_img = 'val_img_path/'
    data_path_val_msk = 'val_mask_annotation_path/'

    data_path_test_img = 'test_img_path/'
    data_path_test_msk = 'test_mask_annotation_path/'


    data_path_train_fovea='train_fovea_file.txt'  ### Each line in the file shows: image_name, fovea_coordinate_x, fovea_coordinate_y.
    data_path_val_fovea = 'val_fovea_file.txt'
    data_path_test_fovea ='test_fovea_file.txt'
